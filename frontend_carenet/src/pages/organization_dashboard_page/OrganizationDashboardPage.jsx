...
import { TrendingUp, DollarSign, FileText, Calculator, Users, MapPin, Calendar, Crown } from "lucide-react"
...
const OrganizationDashboardPage = () => {
  ...
  return (
    <div className={styles.dashboardContainer}>
      ...
      <div className={`${styles.mainContent} ${isBasic ? styles.mainContentBlurred : ''}`}>
        <CustomToast />
        ...
        >
          ...
          <Text className={styles.modalDescription}>Chọn tháng và năm để tính toán doanh thu</Text>
        </Modal>
        ...
        <Row gutter={[16, 16]}>
          <Col xs={24} sm={12} lg={6}>
            <Card hoverable className={styles.statsCard}>
              <Statistic
                title={<Text className={styles.statsTitle}>Tổng doanh thu chứng chỉ</Text>}
          ...
          <Col xs={24} sm={12} lg={6}>
            <Card hoverable className={styles.statsCard}>
              <Statistic
                title={<Text className={styles.statsTitle}>Doanh thu tháng này</Text>}
          ...
          <Col xs={24} sm={12} lg={6}>
            <Card hoverable className={styles.statsCard}>
              <Statistic
                title={<Text className={styles.statsTitle}>Tổng số sự kiện</Text>}
          ...
          <Col xs={24} sm={12} lg={6}>
            <Card hoverable className={styles.statsCard}>
              <Statistic
                title={<Text className={styles.statsTitle}>Chứng chỉ đã bán tháng này</Text>}
        ...
        <Row gutter={[16, 16]} style={{ marginTop: "24px" }}>
          <Col xs={24} lg={12}>
            <Card
              title={<Text className={styles.chartTitle}>Biểu đồ doanh thu chứng chỉ theo tháng</Text>}
              className={styles.chartCard}
              extra={<Text className={styles.chartExtra}>Năm {selectedYear}</Text>}
            >
          ...
          <Col xs={24} lg={12}>
            <Card
              title={<Text className={styles.chartTitle}>Chi tiết doanh thu theo tháng</Text>}
              className={styles.chartCard}
              extra={<Text className={styles.chartExtra}>Năm {selectedYear}</Text>}
            >
              <Table
          ...
          <Card className={styles.upgradeModal}>
            <div className={styles.upgradeContent}>
              ...
              <Text className={styles.upgradeDescription}>
                Bạn đang sử dụng gói <strong>Basic</strong>. Nâng cấp lên gói <strong>Pro</strong> để truy cập đầy đủ tính năng dashboard và phân tích doanh thu chi tiết.
              </Text>
