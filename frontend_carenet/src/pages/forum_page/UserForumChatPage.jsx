...
const initialPosts = [
  {
    ...
    content:
      "Hôm nay thời tiết thật đẹp! Ai cũng ra ngoài tận hưởng không khí trong lành nhé 🌞",
    image:
  ...
  },
  {
    ...
    content:
      "Vừa hoàn thành dự án mới! Cảm ơn team đã hỗ trợ nhiệt tình 💪 #teamwork #success",
        ...
        <Card className={styles.postCreator}>
          ...
          <div className={styles.actionIcons}>
            <Upload
              ...
              accept="image/*"
            >
              <Button icon={<PictureOutlined />} className={styles.iconButton}>
                Ảnh/Video
              </Button>
            </Upload>
            <Button icon={<SmileOutlined />} className={styles.iconButton}>
              Cảm xúc
            </Button>
            <Button
              type="primary"
