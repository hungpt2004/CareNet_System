  ...
  const fetchEventDetail = async () => {
    try {
      const response = await axios.get(
        `http://localhost:5000/event/get-event-detail/${id}`
      );
  ...
  const validateForm = () => {
    ...
    if (eventData && eventData.formData && eventData.formData.questions) {
      eventData.formData.questions.forEach((q) => {
        if (
          !formData[q.question] ||
          (Array.isArray(formData[q.question]) &&
            formData[q.question].length === 0)
        ) {
    ...
    if (!formData.agreeTerms)
      newErrors.agreeTerms = "Bạn phải đồng ý với các điều khoản và điều kiện";
    if (!formData.agreeCodeOfConduct)
      newErrors.agreeCodeOfConduct = "Bạn phải đồng ý với quy tắc ứng xử";
      ...
      try {
        ...
        CustomFailedToast(
          error.response?.data?.message ||
            "Có lỗi xảy ra khi gửi đăng ký. Vui lòng thử lại."
        );
      } finally {
        setIsLoading(false);
      }
          ...
          >
            ...
            <Alert variant="success" className="mb-4">
              <p className="mb-0">
                ...
                <strong>{formData.email || currentUser.email}</strong> với tất
                cả thông tin chi tiết.
              </p>
              <p className="mb-0 mt-2">
                Ban tổ chức sẽ xem xét đăng ký của bạn và liên hệ với bạn sớm.
              </p>
            </Alert>
                  ...
                  <Card className="border-0 shadow-sm h-100">
                    ...
                    <Card.Body className="p-4">
                      ...
                      <div className="d-flex align-items-center mb-3">
                        ...
                        <div>
                          ...
                          <div className="text-muted">
                            {formatTime(eventData.startAt)} -{" "}
                            {formatTime(eventData.endAt)}
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="d-flex align-items-center mb-3">
                        ...
                        <div>
                          <div className="fw-bold">
                            {eventData.location.fullAddress || "Không xác định"}
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="d-flex align-items-center mb-3">
                        ...
                        <div>
                          <div className="fw-bold">
                            {eventData.currentParticipants} người tham gia
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="d-flex align-items-center mb-3">
                        ...
                        <div>
                          ...
                          <div>
                            {eventData.organizationId?.name || "Không xác định"}
                          </div>
                        </div>
                      </div>
                      ...
                      <ListGroup variant="flush" className="mb-4">
                        {eventData.skillNeeds &&
                        eventData.skillNeeds.length > 0 ? (
                  ...
                  <Card className="border-0 shadow-sm">
                    <Card.Body className="p-4">
                      ...
                      <Form onSubmit={handleSubmit}>
                        ...
                        {eventData.formData &&
                        eventData.formData.questions &&
                        eventData.formData.questions.length > 0 ? (
                                ...
                                <Form.Group>
                                  ...
                                  {q.type === "text" && (
                                    <Form.Control
                                      ...
                                      onChange={(e) =>
                                        handleChange(e, q.question, q.type)
                                      }
                          ...
                          <Alert variant="warning">
                            Không có câu hỏi bổ sung nào được cấu hình cho sự
                            kiện này.
                          </Alert>
                        )}
                        ...
                        {/* Nút gửi */}
                        <motion.div variants={fadeInUp} className="d-grid mt-4">
                          <Button
