...
const SupportRequestPage = () => {
  ...
  const supportCategories = [
    ...
    { value: "courses", label: "Vấn đề đăng ký" },
    { value: "admission", label: "Vấn đề điểm danh" },
  ...
  const supportOptions = [
    ...
    },
    {
      ...
      description: "Xem hướng dẫn chi tiết về việc đăng ký tham gia",
    ...
    },
    {
      ...
      description: "Tham gia các buổi workshop trực tuyến miễn phí",
      icon: <Users size={24} />,
      link: "#webinars",
      color: "#9C27B0",
    },
...
const handleSubmit = (e) => {
  ...
  setTimeout(() => {
    ...
    CustomSuccessToast("Gửi đơn report thành công")
  ...
  return (
    <>
      <CustomToast />
      <Container fluid className={`${styles.containerSecondary} py-5`} style={{ minHeight: "100vh" }}>
        <Container>
          <Row className="mb-5">
